...
<body>
    ...
    <a href="#" onclick="addItemToCart(<?php echo $row["id"]; ?>, '<?php echo $row["meal_name"]; ?>', <?php echo $row["price"]; ?>);"><?php echo $row["meal_name"]; ?></a>
    ...
    <!-- Modify your menu items to call addItemToCart() on click -->

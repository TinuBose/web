...
<div class="profile-box" id="profile-box">
  <div class="profile-header">
    <!-- Display the default profile picture as a logo -->
    <div class="profile-logo">
      <img src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg?w=2000" style="width:62px;height:67px;margin-left:-16px; alt="Default Profile Logo">
    </div>
...
.profile-dropdown {
  ...
  /* Style for the profile box container */
.profile-box {
...
/* Style for user details (name and email) */
.profile-details {
  text-align: left;
}
...
.logout-button a {
  ...
  color: #3498db; /* Blue color for the logout link, you can change it to your preference */
  font-weight: bold;
  text-align: right;
  margin-top: 20px;
...
.logout-button a:hover {
  color: #2980b9; /* Darker blue on hover, adjust as needed */
}
